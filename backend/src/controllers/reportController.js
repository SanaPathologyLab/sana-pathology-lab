...
exports.generateReportPDF = async (req, res) => {
  try {
    ...
    // In production, ensure FRONTEND_URL is set in .env
    const frontendUrl = process.env.FRONTEND_URL || 'http://localhost:5173';
    
    await page.goto(`${frontendUrl}/public-print/${report.reportNumber}`, {
    ...
    const filename = `${report.reportNumber}_${report.patient.fullName.replace(/\s+/g, '_')}.pdf`;
