...
exports.createPatient = async (req, res) => {
  try {
    ...
    // Auto-generate 6-digit Telegram linking code if not already provided
    if (!whitelisted.telegramCode) {
      whitelisted.telegramCode = Math.floor(100000 + Math.random() * 900000).toString();
    }
