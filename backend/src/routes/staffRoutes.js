...
const { getStaff, createStaff, updateStaff, deleteStaff, markAttendance, setStaffCredentials } = require('../controllers/staffController');
...
router.post('/:id/credentials', verifyToken, setStaffCredentials);
