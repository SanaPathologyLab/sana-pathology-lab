...
export const generatePrintHTML = (report, settings, includeLetterhead = false) => {
  ...
  const COST = {
    ...
    groupHeader: 1.0,  // sub-group label row
  ...
  const pagesHTML = pages.map((pageData, pageIndex) => {
    ...
    return `
      <div class="report-page">
        ...
        <!-- Report Main Area -->
        <div style="flex-grow: 1; display: flex; flex-direction: column; position: relative; z-index: 10; padding: 0 8px 170px; box-sizing: border-box;">
        ...
        <footer style="position: absolute; bottom: 30mm; left: 0; right: 0; width: auto; padding-left: 14mm; padding-right: 14mm; box-sizing: border-box; display: flex; flex-direction: column; z-index: 20;">
