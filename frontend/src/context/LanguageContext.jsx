...
const translations = {
  en: {
    ...
    "filterOther": "Other",
    // Live Availability
    slotsAvailableToday: "Slots available today",
    bookBefore11: "Book before 11 AM for same-day collection",
    nextAvailableTomorrow: "Next available: Tomorrow 7 AM",
    opensAt7Today: "Slots open at 7 AM today",
    preBookNow: "Pre-book now!",
    opensAt8Today: "Opens at 8 AM today",
    sundayTiming: "Sunday: 8 AM - 1 PM",

    // AI Assistant
    aiAssistantTitle: "AI Diagnostic Assistant",
    aiAssistantDesc: "Describe your symptoms or disease to let AI ask clarifying questions and suggest minimal relevant tests.",
    aiStartBtn: "Consult AI",
    aiResetBtn: "Restart AI",
    aiQuestionsHeader: "AI Clarifying Questions",
    aiSubmitAnswers: "Get Minimal Recommended Tests",
    aiResultHeader: "Recommended Tests",
    aiAddCartBtn: "Add Recommended Tests to Booking",
    aiReasoningHeader: "AI Diagnostic Explanation",
    aiAppliedSuccess: "Recommended tests selected successfully!",
    symptomsPlaceholder: "E.g., fever, chills, coughing since 3 days...",
    answerPlaceholder: "Type your response here...",

    // Loyalty Points
    loyaltyTitle: "Sana Loyalty Points",
    loyaltySubtitle: "Earn points on every test booking",
    loyaltyBalance: "Your Balance",
    loyaltyPointsLabel: "Points",
    loyaltyEmptyMessage: "Start booking tests to earn Sana Points!",
    loyaltyOffNextBooking: "off your next booking",
    loyaltyNextReward: "Next reward at",
    loyaltyPointsToRedeem: "more points to redeem ₹10 off",
    loyaltyRedeemButton: "Redeem Now",
    loyaltyRedeeming: "Redeeming...",
    loyaltyOff: "Off",
    loyaltyRedeemSuccess: "discount applied successfully!",
    loyaltyEarnMore: "Earn",
    loyaltyHistory: "Points History",
    loyaltyNoHistory: "No activity yet. Book tests to earn points!",
    loyaltyEarnedFrom: "Earned from",
    loyaltyRedeemedLabel: "Redeemed",
    loyaltyFooter: "Earn 10 Sana Points for every ₹100 spent on tests",
  },
  hi: {
    // Header & Navigation
    ...
    // Live Availability
    slotsAvailableToday: "आज स्लॉट उपलब्ध",
    bookBefore11: "सुबह 11 बजे से पहले बुक करें",
    nextAvailableTomorrow: "कल सुबह 7 बजे उपलब्ध",
    opensAt7Today: "आज सुबह 7 बजे खुलते हैं",
    preBookNow: "अभी प्री-बुक करें",
    opensAt8Today: "आज सुबह 8 बजे खुलते हैं",
    sundayTiming: "रविवार: सुबह 8 बजे - दोपहर 1 बजे",

    // AI Assistant
    aiAssistantTitle: "एआई स्वास्थ्य सहायक",
    aiAssistantDesc: "अपने लक्षणों या बीमारी का वर्णन करें ताकि एआई स्पष्ट प्रश्न पूछ सके और न्यूनतम प्रासंगिक टेस्ट सुझा सके।",
    aiStartBtn: "एआई से परामर्श लें",
    aiResetBtn: "पुनः आरंभ करें",
    aiQuestionsHeader: "एआई स्पष्टीकरण प्रश्न",
    aiSubmitAnswers: "न्यूनतम अनुशंसित टेस्ट प्राप्त करें",
    aiResultHeader: "अनुशंसित टेस्ट",
    aiAddCartBtn: "अनुशंसित टेस्ट बुकिंग में जोड़ें",
    aiReasoningHeader: "एआई नैदानिक स्पष्टीकरण",
    aiAppliedSuccess: "अनुशंसित टेस्ट सफलतापूर्वक चुने गए!",
    symptomsPlaceholder: "जैसे, बुखार, ठंड लगना, 3 दिनों से खांसी...",
    answerPlaceholder: "अपनी प्रतिक्रिया यहाँ लिखें...",

    // Loyalty Points
    loyaltyTitle: "सना लॉयल्टी पॉइंट्स",
    loyaltySubtitle: "हर टेस्ट बुकिंग पर पॉइंट्स कमाएं",
    loyaltyBalance: "आपका बैलेंस",
    loyaltyPointsLabel: "पॉइंट्स",
    loyaltyEmptyMessage: "सना पॉइंट्स कमाने के लिए टेस्ट बुक करना शुरू करें!",
    loyaltyOffNextBooking: "की छूट अगली बुकिंग पर",
    loyaltyNextReward: "अगला रिवॉर्ड",
    loyaltyPointsToRedeem: "और पॉइंट्स चाहिए ₹10 छूट के लिए",
    loyaltyRedeemButton: "अभी रिडीम करें",
    loyaltyRedeeming: "रिडीम हो रहा है...",
    loyaltyOff: "छूट",
    loyaltyRedeemSuccess: "छूट सफलतापूर्वक लागू!",
    loyaltyEarnMore: "कमाएं",
    loyaltyHistory: "पॉइंट्स हिस्ट्री",
    loyaltyNoHistory: "अभी तक कोई गतिविधि नहीं। टेस्ट बुक करके पॉइंट्स कमाएं!",
    loyaltyEarnedFrom: "से कमाए",
    loyaltyRedeemedLabel: "रिडीम किया",
    loyaltyFooter: "हर ₹100 के टेस्ट पर 10 सना पॉइंट्स कमाएं",
  }
};
