              ...
              return (
                <React.Fragment key={res.id || idx}>
                  ...
                  {isImmunology ? (
                    ...
                    <tr>
                      <td className={`py-1 font-semibold uppercase ${isQual ? 'w-[70%]' : 'w-[35%]'} align-top`}>{res.parameterName}</td>
                      ...
                      {!isQual && (
                        <>
                          ...
                          <td className="py-1 text-center font-semibold whitespace-nowrap w-[25%] align-top text-[12px] leading-tight">{res.referenceRange}</td>
                        </>
                      )}
                    </tr>
                  )}
