    ...
    <div className={`min-h-screen w-full flex flex-col md:flex-row font-sans relative overflow-hidden transition-colors duration-500 ${
      ...
      <div className="hidden md:flex md:w-5/12 bg-[#085041] relative flex-col justify-between p-12 text-white overflow-hidden shadow-2xl">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 cursor-pointer hover:opacity-90 transition-opacity select-none" onClick={() => navigate('/')} title="Back to Homepage">
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-6 md:p-12 relative">
        ...
        <div className="md:hidden flex flex-col items-center mb-6 text-center cursor-pointer hover:opacity-90 transition-opacity select-none" onClick={() => navigate('/')} title="Back to Homepage">
        ...
        <div className={`w-full max-w-lg p-8 md:p-10 rounded-[2.5rem] shadow-2xl border transition-all duration-500 relative ${
          ...
          <button 
            type="button"
            onClick={() => navigate('/')}
            className={`absolute top-6 left-6 p-2 rounded-xl border transition-all duration-200 flex items-center justify-center gap-1.5 text-xs font-bold ${
              darkMode 
          ...
          <div className="mt-8 text-center border-t border-slate-100 pt-6 flex justify-center items-center">
            ...
            >
              <WhatsAppIcon size={14} /> Portal Helpline Support
            </a>
          </div>
