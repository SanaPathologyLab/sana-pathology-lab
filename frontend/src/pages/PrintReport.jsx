...
const PrintReport = () => {
  ...
  const handleTelegram = () => {
    const reportUrl = `${window.location.origin}${import.meta.env.BASE_URL}#/public-print/${report.reportNumber}?patientName=${encodeURIComponent(patient.fullName || '')}`;
  ...
  return (
    <>
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .report-page.is-capturing:last-of-type {
