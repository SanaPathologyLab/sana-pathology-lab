  ...
  <svg viewBox="0 0 100 100" className={className} xmlns="http://www.w3.org/2000/svg">
    ...
    <defs>
      <linearGradient id="gradRight" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" style={{ stopColor: '#e03a3c', stopOpacity: 1 }} />
        <stop offset="50%" style={{ stopColor: '#d62d60', stopOpacity: 1 }} />
        <stop offset="100%" style={{ stopColor: '#7a28cb', stopOpacity: 1 }} />
      </linearGradient>
      <linearGradient id="gradLeft" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" style={{ stopColor: '#00a8e8', stopOpacity: 1 }} />
        <stop offset="100%" style={{ stopColor: '#00488d', stopOpacity: 1 }} />
      </linearGradient>
    </defs>
  </svg>
);
