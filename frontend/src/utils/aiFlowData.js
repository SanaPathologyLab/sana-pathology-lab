export const QUESTION_FLOW = {
  start: {
    ...
    options: [
      ...
      { label: { en: "Women's health (periods/PCOS)", hi: "महिला स्वास्थ्य (मासिक धर्म/पीसीओएस)" }, next_node: "womens_health" },
      { label: { en: "Eye or vision problem", hi: "आँख या दृष्टि की समस्या" }, next_node: "eye_problem" },
      { label: { en: "Sleep problems (insomnia)", hi: "नींद की समस्या (अनिद्रा)" }, next_node: "sleep_problem" },
      { label: { en: "Anxiety, stress or palpitations", hi: "घबराहट, तनाव या धड़कन" }, next_node: "anxiety_stress" },
      { label: { en: "Digestive issues (gas, acidity)", hi: "पाचन समस्या (गैस, एसिडिटी)" }, next_node: "digestive_issue" },
      { label: { en: "Child health concern", hi: "बच्चों की स्वास्थ्य समस्या" }, next_node: "child_health" },
      { label: { en: "Weight management", hi: "वजन प्रबंधन" }, next_node: "weight_manage" },
      { label: { en: "Men's health checkup", hi: "पुरुष स्वास्थ्य जाँच" }, next_node: "result", result_key: "men_health" },
      { label: { en: "Post-COVID recovery checkup", hi: "कोविड के बाद स्वास्थ्य जांच" }, next_node: "post_covid" }
    ]
  },
  ...
  womens_health: {
    id: "womens_health",
    question: {
      en: "What is your main women's health concern?",
      hi: "आपकी मुख्य महिला स्वास्थ्य संबंधी चिंता क्या है?"
    },
    options: [
      { label: { en: "Irregular periods or PCOS suspected", hi: "अनियमित मासिक धर्म या पीसीओएस का संदेह" }, next_node: "result", result_key: "womens_health_menses" },
      { label: { en: "Menopause or perimenopause concerns", hi: "रजोनिवृत्ति या पेरिमेनोपॉज़ संबंधी चिंताएँ" }, next_node: "result", result_key: "womens_health_menopause" },
      { label: { en: "Heavy bleeding during periods", hi: "मासिक धर्म के दौरान अत्यधिक रक्तस्राव" }, next_node: "result", result_key: "womens_health_menses" },
      { label: { en: "Routine female health checkup", hi: "नियमित महिला स्वास्थ्य जाँच" }, next_node: "result", result_key: "checkup_female_30_45" }
    ]
  },
  ...
  eye_problem: {
    id: "eye_problem",
    question: {
      en: "What kind of eye or vision problem do you have?",
      hi: "आपको किस तरह की आँख या दृष्टि की समस्या है?"
    },
    options: [
      { label: { en: "Blurry or double vision", hi: "धुंधली या दोहरी दृष्टि" }, next_node: "result", result_key: "eye_problem_detail" },
      { label: { en: "Dry eyes or eye discomfort", hi: "सूखी आँखें या आँखों में असुविधा" }, next_node: "result", result_key: "eye_problem_detail" },
      { label: { en: "Yellow eyes (jaundice)", hi: "पीली आँखें (पीलिया)" }, next_node: "jaundice_duration" },
      { label: { en: "Protruding or bulging eyes", hi: "आँखों का उभार या बाहर निकलना" }, next_node: "result", result_key: "eye_problem_detail" }
    ]
  },
  ...
  sleep_problem: {
    id: "sleep_problem",
    question: {
      en: "What kind of sleep problem are you experiencing?",
      hi: "आपको किस तरह की नींद की समस्या हो रही है?"
    },
    options: [
      { label: { en: "Difficulty falling asleep (insomnia)", hi: "सोने में कठिनाई (अनिद्रा)" }, next_node: "result", result_key: "sleep_problem_detail" },
      { label: { en: "Waking up frequently at night", hi: "रात में बार-बार जागना" }, next_node: "result", result_key: "sleep_problem_detail" },
      { label: { en: "Excessive daytime sleepiness", hi: "दिन में अत्यधिक नींद आना" }, next_node: "result", result_key: "sleep_problem_detail" },
      { label: { en: "Snoring or breathing pauses (sleep apnea concern)", hi: "खर्राटे या सांस रुकना (स्लीप एपनिया का संदेह)" }, next_node: "result", result_key: "sleep_problem_detail" }
    ]
  },
  ...
  anxiety_stress: {
    id: "anxiety_stress",
    question: {
      en: "What symptoms of anxiety or stress are you experiencing?",
      hi: "आप घबराहट या तनाव के कौन से लक्षण अनुभव कर रहे हैं?"
    },
    options: [
      { label: { en: "Heart palpitations or racing heartbeat", hi: "दिल की धड़कन तेज होना" }, next_node: "result", result_key: "anxiety_stress_detail" },
      { label: { en: "Trembling hands or excessive sweating", hi: "हाथ कांपना या अत्यधिक पसीना आना" }, next_node: "result", result_key: "anxiety_stress_detail" },
      { label: { en: "Generalized anxiety or panic attacks", hi: "सामान्य चिंता या पैनिक अटैक" }, next_node: "result", result_key: "anxiety_stress_detail" },
      { label: { en: "Mood swings or irritability", hi: "मूड स्विंग या चिड़चिड़ापन" }, next_node: "result", result_key: "anxiety_stress_detail" }
    ]
  },
  ...
  digestive_issue: {
    id: "digestive_issue",
    question: {
      en: "What digestive problem are you experiencing?",
      hi: "आपको कौन सी पाचन समस्या हो रही है?"
    },
    options: [
      { label: { en: "Acidity, heartburn or GERD", hi: "एसिडिटी, सीने में जलन या GERD" }, next_node: "result", result_key: "digestive_issue_detail" },
      { label: { en: "Bloating, gas or indigestion", hi: "पेट फूलना, गैस या अपच" }, next_node: "result", result_key: "digestive_issue_detail" },
      { label: { en: "Nausea or vomiting", hi: "मतली या उल्टी" }, next_node: "result", result_key: "liver_nausea" },
      { label: { en: "Chronic diarrhea or constipation", hi: "पुराना दस्त या कब्ज" }, next_node: "result", result_key: "digestive_issue_detail" },
      { label: { en: "Right side abdominal pain", hi: "पेट के दाहिनी ओर दर्द" }, next_node: "result", result_key: "liver_pain" }
    ]
  },
  ...
  child_health: {
    id: "child_health",
    question: {
      en: "What is the child's main health concern?",
      hi: "बच्चे की मुख्य स्वास्थ्य समस्या क्या है?"
    },
    options: [
      { label: { en: "Fever in child", hi: "बच्चे को बुखार" }, next_node: "result", result_key: "child_health_fever" },
      { label: { en: "Poor growth, weight, or development", hi: "धीमी वृद्धि, वजन या विकास" }, next_node: "result", result_key: "child_health_growth" },
      { label: { en: "Recurrent infections or colds", hi: "बार-बार संक्रमण या सर्दी" }, next_node: "result", result_key: "child_health_growth" },
      { label: { en: "Pale skin or tiredness (anemia concern)", hi: "पीली त्वचा या थकान (एनीमिया का संदेह)" }, next_node: "result", result_key: "anemia_general" }
    ]
  },
  ...
  weight_manage: {
    id: "weight_manage",
    question: {
      en: "What is your weight-related concern?",
      hi: "आपकी वजन से संबंधित क्या चिंता है?"
    },
    options: [
      { label: { en: "Unexplained weight gain", hi: "बिना कारण वजन बढ़ना" }, next_node: "result", result_key: "weight_manage_gain" },
      { label: { en: "Unexplained weight loss", hi: "बिना कारण वजन कम होना" }, next_node: "result", result_key: "weakness_diabetes" },
      { label: { en: "Difficulty losing weight despite diet/exercise", hi: "डाइट/व्यायाम के बावजूद वजन कम करने में कठिनाई" }, next_node: "result", result_key: "weight_manage_gain" },
      { label: { en: "General obesity / metabolic syndrome concern", hi: "सामान्य मोटापा / मेटाबॉलिक सिंड्रोम की चिंता" }, next_node: "result", result_key: "weight_manage_gain" }
    ]
  },
  ...
  post_covid: {
    id: "post_covid",
    question: {
      en: "What post-COVID symptoms are you experiencing?",
      hi: "आप कोविड के बाद कौन से लक्षण अनुभव कर रहे हैं?"
    },
    options: [
      { label: { en: "Persistent fatigue or weakness", hi: "लगातार थकान या कमजोरी" }, next_node: "result", result_key: "post_covid_detail" },
      { label: { en: "Breathlessness or chest discomfort", hi: "सांस फूलना या सीने में तकलीफ" }, next_node: "result", result_key: "post_covid_detail" },
      { label: { en: "Hair loss or skin issues", hi: "बालों का झड़ना या त्वचा की समस्याएँ" }, next_node: "result", result_key: "post_covid_detail" },
      { label: { en: "General post-COVID health checkup", hi: "सामान्य कोविड के बाद स्वास्थ्य जाँच" }, next_node: "result", result_key: "post_covid_detail" }
    ]
  }
};
...
export const TEST_RECOMMENDATIONS = {
  ...
  womens_health_menses: {
    label: { en: "Women's Health — Irregular periods / PCOS suspected", hi: "महिला स्वास्थ्य — अनियमित मासिक धर्म / पीसीओएस संदिग्ध" },
    summary: {
      en: "Irregular periods can indicate PCOS, thyroid disorder, or hormonal imbalance. Comprehensive hormonal screening recommended.",
      hi: "अनियमित मासिक धर्म पीसीओएस, थायराइड विकार या हार्मोनल असंतुलन का संकेत हो सकता है। व्यापक हार्मोनल जांच की सिफारिश की जाती है।"
    },
    must_do: [
      { test_code: "TFT", reason: { en: "Thyroid dysfunction is a leading cause of menstrual irregularities", hi: "थायराइड की शिथिलता मासिक धर्म की अनियमितता का एक प्रमुख कारण है" } },
      { test_code: "CBC", reason: { en: "Assess for anemia from heavy bleeding", hi: "भारी रक्तस्राव से एनीमिया का आकलन करें" } },
      { test_code: "HB-01", reason: { en: "Hemoglobin levels check for menorrhagia", hi: "अत्यधिक रक्तस्राव के लिए हीमोग्लोबिन स्तर की जाँच" } }
    ],
    recommended: [
      { test_code: "FBS", reason: { en: "PCOS is strongly linked to insulin resistance and diabetes", hi: "पीसीओएस इंसुलिन प्रतिरोध और मधुमेह से दृढ़ता से जुड़ा है" } },
      { test_code: "LIPID", reason: { en: "PCOS increases cardiovascular and lipid risk", hi: "पीसीओएस हृदय और लिपिड जोखिम को बढ़ाता है" } }
    ],
    optional: [
      { test_code: "URINE", reason: { en: "General health screening", hi: "सामान्य स्वास्थ्य स्क्रीनिंग" } }
    ],
    ai_note: {
      en: "PCOS is diagnosed by Rotterdam criteria: oligo/anovulation, clinical/biochemical hyperandrogenism, and polycystic ovaries on ultrasound.",
      hi: "पीसीओएस का निदान रॉटरडैम मानदंडों द्वारा किया जाता है: ओलिगो/एनोव्यूलेशन, नैदानिक/जैव रासायनिक हाइपरएंड्रोजेनिज्म और अल्ट्रासाउंड पर पॉलीसिस्टिक अंडाशय।"
    }
  },

  womens_health_menopause: {
    label: { en: "Women's Health — Perimenopause / Menopause concerns", hi: "महिला स्वास्थ्य — पेरिमेनोपॉज़ / रजोनिवृत्ति संबंधी चिंताएँ" },
    summary: {
      en: "Metabolic and bone health screening for women in the menopausal transition.",
      hi: "रजोनिवृत्ति संक्रमण में महिलाओं के लिए चयापचय और हड्डी के स्वास्थ्य की जाँच।"
    },
    must_do: [
      { test_code: "TFT", reason: { en: "Menopause can mask or mimic thyroid symptoms", hi: "रजोनिवृत्ति थायराइड के लक्षणों को छुपा या नकल कर सकती है" } },
      { test_code: "LIPID", reason: { en: "Estrogen decline raises cardiovascular risk after menopause", hi: "एस्ट्रोजन में गिरावट रजोनिवृत्ति के बाद हृदय जोखिम बढ़ाती है" } },
      { test_code: "FBS", reason: { en: "Diabetes risk increases after menopause", hi: "रजोनिवृत्ति के बाद मधुमेह का खतरा बढ़ जाता है" } },
      { test_code: "CALCIUM-01", reason: { en: "Osteoporosis risk increases significantly post-menopause", hi: "रजोनिवृत्ति के बाद ऑस्टियोपोरोसिस का खतरा काफी बढ़ जाता है" } }
    ],
    recommended: [
      { test_code: "CBC", reason: { en: "General blood count screening", hi: "सामान्य रक्त गणना स्क्रीनिंग" } }
    ],
    optional: [
      { test_code: "URINE", reason: { en: "UTI risk increases after menopause", hi: "रजोनिवृत्ति के बाद यूटीआई का खतरा बढ़ जाता है" } }
    ]
  },

  men_health: {
    label: { en: "Men's Health — General screening", hi: "पुरुष स्वास्थ्य — सामान्य जाँच" },
    summary: {
      en: "Comprehensive health screening tailored for men, focusing on cardiac, metabolic, and lifestyle-related risks.",
      hi: "पुरुषों के लिए विशेष स्वास्थ्य जाँच, जिसमें हृदय, चयापचय और जीवनशैली से संबंधित जोखिमों पर ध्यान केंद्रित किया गया है।"
    },
    must_do: [
      { test_code: "CBC", reason: { en: "Baseline blood count", hi: "आधारभूत रक्त गणना" } },
      { test_code: "LIPID", reason: { en: "Men have higher cardiac risk than women at similar ages", hi: "समान उम्र में पुरुषों में महिलाओं की तुलना में हृदय जोखिम अधिक होता है" } },
      { test_code: "FBS", reason: { en: "Diabetes screening", hi: "मधुमेह स्क्रीनिंग" } },
      { test_code: "LFT", reason: { en: "Fatty liver and alcohol-related liver disease is common in men", hi: "फैटी लीवर और शराब से संबंधित लीवर रोग पुरुषों में आम है" } }
    ],
    recommended: [
      { test_code: "KFT", reason: { en: "Kidney function baseline", hi: "किडनी फंक्शन बेसलाइन" } },
      { test_code: "URINE", reason: { en: "General screening", hi: "सामान्य स्क्रीनिंग" } }
    ],
    optional: [
      { test_code: "CALCIUM-01", reason: { en: "Bone health screening", hi: "हड्डी के स्वास्थ्य की जाँच" } }
    ]
  },

  eye_problem_detail: {
    label: { en: "Vision / Eye problem", hi: "दृष्टि / आँख की समस्या" },
    summary: {
      en: "Vision changes can indicate diabetes (diabetic retinopathy), hypertension, thyroid eye disease, or nutritional deficiencies.",
      hi: "दृष्टि में बदलाव मधुमेह (डायबिटिक रेटिनोपैथी), उच्च रक्तचाप, थायराइड नेत्र रोग या पोषण संबंधी कमियों का संकेत हो सकता है।"
    },
    must_do: [
      { test_code: "FBS", reason: { en: "Blurry vision is a classic sign of diabetes", hi: "धुंधली दृष्टि मधुमेह का एक क्लासिक संकेत है" } },
      { test_code: "HBA1C", reason: { en: "Assess long-term glucose control", hi: "दीर्घकालिक ग्लूकोज नियंत्रण का आकलन करें" } },
      { test_code: "TFT", reason: { en: "Thyroid disorders can cause eye bulging (exophthalmos) or dry eyes", hi: "थायराइड विकार आँखों के उभार या सूखी आँखों का कारण बन सकते हैं" } }
    ],
    recommended: [
      { test_code: "LIPID", reason: { en: "High cholesterol causes xanthelasma (yellow deposits around eyes)", hi: "उच्च कोलेस्ट्रॉल आँखों के आसपास पीले जमाव का कारण बनता है" } },
      { test_code: "CBC", reason: { en: "Severe anemia can cause vision disturbances", hi: "गंभीर एनीमिया दृष्टि गड़बड़ी का कारण बन सकता है" } }
    ],
    optional: [
      { test_code: "CRP-01", reason: { en: "Inflammatory eye conditions", hi: "सूजन संबंधी आँख की स्थितियाँ" } }
    ]
  },

  sleep_problem_detail: {
    label: { en: "Sleep issues / Insomnia", hi: "नींद की समस्या / अनिद्रा" },
    summary: {
      en: "Chronic sleep issues can be caused by thyroid dysfunction, blood sugar fluctuations, anemia, or stress.",
      hi: "पुरानी नींद की समस्या थायराइड की शिथिलता, रक्त शर्करा में उतार-चढ़ाव, एनीमिया या तनाव के कारण हो सकती है।"
    },
    must_do: [
      { test_code: "TFT", reason: { en: "Both hyperthyroidism and hypothyroidism disrupt sleep patterns", hi: "हाइपरथायरायडिज्म और हाइपोथायरायडिज्म दोनों नींद के पैटर्न को बाधित करते हैं" } },
      { test_code: "FBS", reason: { en: "Nocturnal hypoglycemia can cause night waking", hi: "रात्रिकालीन हाइपोग्लाइसीमिया रात में जागने का कारण बन सकता है" } },
      { test_code: "CBC", reason: { en: "Anemia causes fatigue during day and restless legs at night", hi: "एनीमिया दिन में थकान और रात में बेचैन पैरों का कारण बनता है" } }
    ],
    recommended: [
      { test_code: "VITD", reason: { en: "Vitamin D deficiency is linked to sleep disorders", hi: "विटामिन डी की कमी नींद विकारों से जुड़ी है" } },
      { test_code: "CALCIUM-01", reason: { en: "Calcium deficiency can cause muscle cramps disrupting sleep", hi: "कैल्शियम की कमी से मांसपेशियों में ऐंठन हो सकती है जो नींद को बाधित करती है" } }
    ],
    optional: [
      { test_code: "LIPID", reason: { en: "Metabolic health check", hi: "चयापचय स्वास्थ्य जाँच" } }
    ]
  },

  anxiety_stress_detail: {
    label: { en: "Anxiety / Stress / Palpitations", hi: "घबराहट / तनाव / धड़कन" },
    summary: {
      en: "Palpitations and anxiety can be driven by an overactive thyroid, low blood sugar, anemia, or electrolyte imbalances.",
      hi: "धड़कन और चिंता एक अति सक्रिय थायराइड, निम्न रक्त शर्करा, एनीमिया या इलेक्ट्रोलाइट असंतुलन के कारण हो सकते हैं।"
    },
    must_do: [
      { test_code: "TFT", reason: { en: "Hyperthyroidism commonly presents with anxiety, palpitations, and sweating", hi: "हाइपरथायरायडिज्म आमतौर पर चिंता, धड़कन और पसीने के साथ प्रस्तुत होता है" } },
      { test_code: "FBS", reason: { en: "Hypoglycemia mimics anxiety symptoms", hi: "हाइपोग्लाइसीमिया चिंता के लक्षणों की नकल करता है" } },
      { test_code: "CBC", reason: { en: "Anemia can cause palpitations and fatigue", hi: "एनीमिया धड़कन और थकान का कारण बन सकता है" } }
    ],
    recommended: [
      { test_code: "LIPID", reason: { en: "Stress increases cardiovascular risk; assess baseline lipids", hi: "तनाव हृदय जोखिम बढ़ाता है; आधारभूत लिपिड का आकलन करें" } },
      { test_code: "CALCIUM-01", reason: { en: "Electrolyte imbalances affect heart rhythm", hi: "इलेक्ट्रोलाइट असंतुलन हृदय की लय को प्रभावित करता है" } }
    ],
    optional: [
      { test_code: "URINE", reason: { en: "General health screening", hi: "सामान्य स्वास्थ्य स्क्रीनिंग" } }
    ]
  ...
  digestive_issue_detail: {
    label: { en: "Digestive issues / Acidity / Gas / IBS", hi: "पाचन समस्या / एसिडिटी / गैस / आईबीएस" },
    summary: {
      en: "Chronic digestive issues may be linked to liver function, gallbladder issues, food intolerances, or thyroid dysfunction.",
      hi: "पुरानी पाचन समस्याएं लीवर फंक्शन, पित्ताशय की समस्याओं, खाद्य असहिष्णुता या थायराइड की शिथिलता से जुड़ी हो सकती हैं।"
    },
    must_do: [
      { test_code: "LFT", reason: { en: "Liver produces bile; dysfunction causes bloating and indigestion", hi: "लीवर पित्त बनाता है; शिथिलता से सूजन और अपच होता है" } },
      { test_code: "CBC", reason: { en: "Screen for underlying infection or inflammation", hi: "अंतर्निहित संक्रमण या सूजन की जाँच करें" } },
      { test_code: "TFT", reason: { en: "Hypothyroidism slows gut motility, causing constipation and bloating", hi: "हाइपोथायरायडिज्म आंतों की गति को धीमा करता है, जिससे कब्ज और सूजन होती है" } }
    ],
    recommended: [
      { test_code: "FBS", reason: { en: "Diabetes can cause gastroparesis (delayed stomach emptying)", hi: "मधुमेह गैस्ट्रोपेरेसिस (पेट खाली होने में देरी) का कारण बन सकता है" } },
      { test_code: "URINE", reason: { en: "General health screening", hi: "सामान्य स्वास्थ्य स्क्रीनिंग" } }
    ],
    optional: [
      { test_code: "LIPID", reason: { en: "Gallstones linked to high cholesterol", hi: "पित्त पथरी उच्च कोलेस्ट्रॉल से जुड़ी है" } }
    ]
  },

  child_health_fever: {
    label: { en: "Child Health — Fever in child", hi: "बच्चों का स्वास्थ्य — बच्चे को बुखार" },
    summary: {
      en: "Fever in children requires careful evaluation. CBC helps differentiate viral vs bacterial infection.",
      hi: "बच्चों में बुखार का सावधानीपूर्वक मूल्यांकन आवश्यक है। सीबीसी वायरल बनाम बैक्टीरियल संक्रमण में अंतर करने में मदद करता है।"
    },
    must_do: [
      { test_code: "CBC", reason: { en: "WBC pattern differentiates viral from bacterial infection", hi: "डब्ल्यूबीसी पैटर्न वायरल से बैक्टीरियल संक्रमण को अलग करता है" } },
      { test_code: "MP", reason: { en: "Malaria antigen test — common in pediatric fever", hi: "मलेरिया एंटीजन परीक्षण — बच्चों में बुखार में आम" } },
      { test_code: "URINE", reason: { en: "UTI is a common cause of unexplained fever in children", hi: "यूटीआई बच्चों में अस्पष्टीकृत बुखार का एक सामान्य कारण है" } }
    ],
    recommended: [
      { test_code: "CRP-01", reason: { en: "Infection/inflammation marker", hi: "संक्रमण/सूजन का संकेतक" } }
    ],
    optional: [
      { test_code: "DENGUE-01", reason: { en: "If endemic area or rash present", hi: "यदि स्थानिक क्षेत्र या चकत्ते मौजूद हैं" } }
    ]
  },

  child_health_growth: {
    label: { en: "Child Health — Poor growth / development", hi: "बच्चों का स्वास्थ्य — धीमी वृद्धि / विकास" },
    summary: {
      en: "Growth delay in children can be caused by anemia, thyroid dysfunction, calcium deficiency, or chronic infections.",
      hi: "बच्चों में वृद्धि में देरी एनीमिया, थायराइड की शिथिलता, कैल्शियम की कमी या पुराने संक्रमण के कारण हो सकती है।"
    },
    must_do: [
      { test_code: "CBC", reason: { en: "Screen for anemia — most common cause of growth issues", hi: "एनीमिया की जाँच करें — वृद्धि समस्याओं का सबसे आम कारण" } },
      { test_code: "TFT", reason: { en: "Thyroid hormone is essential for normal growth and development", hi: "थायराइड हार्मोन सामान्य वृद्धि और विकास के लिए आवश्यक है" } },
      { test_code: "CALCIUM-01", reason: { en: "Calcium is critical for bone growth and density", hi: "कैल्शियम हड्डियों की वृद्धि और घनत्व के लिए महत्वपूर्ण है" } }
    ],
    recommended: [
      { test_code: "FBS", reason: { en: "Rule out diabetes or hypoglycemia issues", hi: "मधुमेह या हाइपोग्लाइसीमिया की समस्याओं को खारिज करें" } },
      { test_code: "HB-01", reason: { en: "Hemoglobin check", hi: "हीमोग्लोबिन की जाँच" } }
    ],
    optional: [
      { test_code: "URINE", reason: { en: "Screen for chronic UTI or kidney issues", hi: "पुरानी यूटीआई या किडनी की समस्याओं की जाँच करें" } }
    ]
  },

  weight_manage_gain: {
    label: { en: "Weight management — Unexplained weight gain", hi: "वजन प्रबंधन — अस्पष्टीकृत वजन बढ़ना" },
    summary: {
      en: "Unexplained weight gain despite normal diet and exercise strongly suggests hypothyroidism or insulin resistance.",
      hi: "सामान्य आहार और व्यायाम के बावजूद अस्पष्टीकृत वजन बढ़ना हाइपोथायरायडिज्म या इंसुलिन प्रतिरोध का संकेत देता है।"
    },
    must_do: [
      { test_code: "TFT", reason: { en: "Hypothyroidism is the most common endocrine cause of weight gain", hi: "हाइपोथायरायडिज्म वजन बढ़ने का सबसे आम अंतःस्रावी कारण है" } },
      { test_code: "FBS", reason: { en: "Insulin resistance and pre-diabetes are linked to weight gain", hi: "इंसुलिन प्रतिरोध और प्री-डायबिटीज वजन बढ़ने से जुड़े हैं" } },
      { test_code: "LIPID", reason: { en: "Metabolic syndrome screening includes lipid panel", hi: "मेटाबॉलिक सिंड्रोम जांच में लिपिड पैनल शामिल है" } }
    ],
    recommended: [
      { test_code: "CBC", reason: { en: "General health baseline", hi: "सामान्य स्वास्थ्य आधारभूत स्तर" } },
      { test_code: "CALCIUM-01", reason: { en: "Bone and mineral health check", hi: "हड्डी और खनिज स्वास्थ्य की जाँच" } }
    ],
    optional: [
      { test_code: "URINE", reason: { en: "General screening", hi: "सामान्य स्क्रीनिंग" } }
    ]
  ...
  post_covid_detail: {
    label: { en: "Post-COVID Recovery Checkup", hi: "कोविड के बाद स्वास्थ्य जांच" },
    summary: {
      en: "Post-COVID syndrome can affect multiple organ systems. Comprehensive panel recommended for recovery assessment.",
      hi: "पोस्ट-कोविड सिंड्रोम कई अंग प्रणालियों को प्रभावित कर सकता है। रिकवरी मूल्यांकन के लिए व्यापक पैनल की सिफारिश की जाती है।"
    },
    must_do: [
      { test_code: "CBC", reason: { en: "Check for persistent inflammation or anemia post-infection", hi: "संक्रमण के बाद लगातार सूजन या एनीमिया की जाँच करें" } },
      { test_code: "LFT", reason: { en: "COVID-19 and medications can impact liver function", hi: "कोविड-19 और दवाएं लीवर के कार्य को प्रभावित कर सकती हैं" } },
      { test_code: "KFT", reason: { en: "Assess kidney function post-illness", hi: "बीमारी के बाद किडनी के कार्य का आकलन करें" } },
      { test_code: "CRP-QUANT-01", reason: { en: "Monitor for lingering inflammation", hi: "लंबे समय तक रहने वाली सूजन की निगरानी करें" } },
      { test_code: "TFT", reason: { en: "Thyroid dysfunction is common after COVID-19", hi: "कोविड-19 के बाद थायराइड की शिथिलता आम है" } }
    ],
    recommended: [
      { test_code: "FBS", reason: { en: "New onset diabetes has been reported post-COVID", hi: "कोविड के बाद नए मधुमेह की शुरुआत की सूचना मिली है" } },
      { test_code: "LIPID", reason: { en: "COVID-19 can affect lipid metabolism", hi: "कोविड-19 लिपिड चयापचय को प्रभावित कर सकता है" } }
    ],
    optional: [
      { test_code: "VITD", reason: { en: "Vitamin D levels influence immune recovery", hi: "विटामिन डी का स्तर प्रतिरक्षा रिकवरी को प्रभावित करता है" } },
      { test_code: "CALCIUM-01", reason: { en: "General mineral balance check", hi: "सामान्य खनिज संतुलन की जाँच" } }
    ]
  }
};
